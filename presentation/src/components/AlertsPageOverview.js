...
function AlertPageOverview({alert}) {
    ...
    return (
        ...
        {/* Network status grid */}
              <div className="col-span-2 border border-[#e7e7e7] dark:border-[#353535] shadow-md rounded-xl px-4 py-4 bg-[#efe8ff] dark:bg-[#252525]">
              ...
              <div className="col-span-4 border border-[#e7e7e7] dark:border-[#353535] shadow-md rounded-xl px-4 py-4 bg-[#efe8ff] dark:bg-[#252525]">
                  <div className="">
