...
function AlertOverview({alert}) {
    ...
    if (severity <= 10) {
      networkStatus = "Good";
      emoji = (
        <svg className="w-11 h-11 text-[#51ff2e]" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      ...
      emoji = (
        <svg className="w-11 h-11 text-yellow-400" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          <path fillRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2ZM7.99 9a1 1 0 0 1 1-1H9a1 1 0 0 1 0 2h-.01a1 1 0 0 1-1-1ZM14 9a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2H15a1 1 0 0 1-1-1Zm-5.506 7.216A5.5 5.5 0 0 1 6.6 13h10.81a5.5 5.5 0 0 1-8.916 3.216Z" clipRule="evenodd" />
        </svg>
      );
    } else {
      networkStatus = "Bad";
      emoji = (
        <svg className="w-11 h-11 text-[#FF5733]" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          <path fillRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2ZM7.99 9a1 1 0 0 1 1-1H9a1 1 0 0 1 0 2h-.01a1 1 0 0 1-1-1ZM14 9a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2H15a1 1 0 0 1-1-1Zm-5.506 7.216A5.5 5.5 0 0 1 6.6 13h10.81a5.5 5.5 0 0 1-8.916 3.216Z" clipRule="evenodd" />
        </svg>
      );
    }
    ...
    return (
    <div className="flex justify-between flex-col md:flex-row bg-[#efe8ff] dark:bg-[#252525] rounded-xl p-4 pl-10 pr-10 items-center">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center mt-4 md:mt-0 lg:pl-4">
            ...
            <div className="flex flex-col items-start gap-16">
              <div className="flex items-center mb-2">
                  ...
                  Critical
                  <span className="pl-[20px]">{alert.critical}</span>
                  </p>
              </div>
              ...
              <div className="flex items-center mb-2">
                  ...
                  <p className="ml-2 text-sm">
                  High <span className="pl-[34px]">{alert.high}</span>
                  </p>
              </div>
              ...
              <div className="flex items-center mb-2">
                  ...
                  <p className="ml-2 text-sm">
                  Medium <span className="pl-[9px]">{alert.med}</span>
                  </p>
              </div>
              ...
              <div className="flex items-center mb-2">
                  ...
                  <p className="ml-2 text-sm">
                  Low <span className="pl-[39px]">{alert.low}</span>
                  </p>
              </div>
            </div>
        </div>
