...
function NALogInHistory() {
    ...
    return (
        <div className={`${darkMode ? 'dark' : ''}`}>
            <Header />
            <div className="flex flex-col min-h-screen bg-[#f4f4f4] dark:bg-[#1C1D1F] text-black dark:text-white px-4 sm:px-6 md:px-8 lg:px-12" style={{ minHeight: 'calc(100vh - 60px)' }}>
